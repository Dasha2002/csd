<section class="services-two">
    <div class="block">
        ...
        <div class="bloc-one-mobile">

            <div class="block-1-first-row">
                <div class="overlay-img">
                    <img src="/assets/img/services-font.svg" alt="Передний план">
                </div>
            ...
            <div class="block-2-first-row">
                <a href="#">
                    ...
                    <div class="block">
                        <img src="/assets/img/detail-blue-one.svg" class="img-blue-detail">
                        <h2>Банкротство индивидуальных<br> предпринимателей</h2>
                    </div>
        ...
        <div class="block-two">
            ...
            <div class="block-6-third-row">
                <a href="#">
                    <div>
                        <img src="/assets/img/detail-icon.svg">
                        <h2>Вне судебное банкротство</h2>
                    </div>
                </a>
            </div>
