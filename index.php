    ...
    <header>
        ...
        <nav class="nav">
            <ul class="nav-ul">
                ...
                <li class="nav-li"><a class="link" href="#">Услуги и стоимость</a></li>
                <li class="nav-li"><a class="link" href="#">Отзывы</a></li>
                <li class="nav-li"><a class="link" href="#">Контакты</a></li>
                <li class="nav-li"><a class="link" href="#">Статьи</a></li>
                <li class="nav-li"><a class="link" href="#">Завершенные дела</a></li>
    ...
    <section class="services">
        <div class="block">
            ...
            <div class="bloc-one">
                ...
                <div class="block-1-first-row">
                    ...
                    <div class="btn-overlay">
                        <button class="btn-application">Оставить заявку</button>
            ...
            <div class="block-two">
                ...
                <div class="block-7-third-row">
                    <a href="#">
                        <div>
                            <img src="/assets/img/detail-icon.svg">
                            <h2>Дистанционное банкротства</h2>
                        </div>
                    </a>
                </div>
                <div class="block-8-third-row">
                    <a href="#">
                        <div>
                            <img src="/assets/img/detail-icon.svg">
                            <h2>Банкротство с ипотекой</h2>
                        </div>
                    </a>
                </div>

                <div class="block-9-fourth-row">
                    <a href="#">
                        <div>
                            <img src="/assets/img/detail-icon.svg">
                            <h2>Банкротство по налогам</h2>
                        </div>
                    </a>
                </div>
                <div class="block-10-fourth-row">
                    <a href="#">
                        <div>
                            <img src="/assets/img/detail-icon.svg">
                            <h2>Банкротство по штрафам</h2>
                        </div>
                    </a>
                </div>
                <div class="block-11-fourth-row">
                    <a href="#">
                        <div>
                            <img src="/assets/img/detail-icon.svg">
                            <h2>Банкротство пенсионеров</h2>
                        </div>
                    </a>
                </div>
            </div>
